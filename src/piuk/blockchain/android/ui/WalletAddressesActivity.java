...
public final class WalletAddressesActivity extends AbstractWalletActivity
{
	...
	protected void onCreate(final Bundle savedInstanceState)
	{
		...
		if (pager != null)
		{
			...
			pagerTabs.addTabLabels(R.string.address_book_list_receiving_title, R.string.address_book_list_archived_title, R.string.address_book_list_sending_title);
			...
			archivedAddressesFragment = new WalletArchivedAddressesFragment(2, pager);
		...
		else
		{
			...
			activeAddressesFragment = (WalletActiveAddressesFragment) getSupportFragmentManager().findFragmentById(R.id.wallet_addresses_fragment);
	...
	private void reallyGenerateAddress() {
		getWalletApplication().addKeyToWallet(new ECKey(), null, 0, new AddAddressCallback() {
					...
					public void onClick(final DialogInterface dialog, final int which)
					{
						...
						if (remoteWallet.isDoubleEncrypted() == false) {
							...
							if (remoteWallet.temporySecondPassword == null) {
								SecondPasswordFragment.show(getSupportFragmentManager(), new SuccessCallback() {
